...
add_javascript('<script src="'.G5_JS_URL.'/jquery-3.3.1.min.js"></script>', 0);
add_javascript('<script src="'.G5_JS_URL.'/scrolla.jquery.min.js"></script>', 0);
...
add_stylesheet('<link rel="stylesheet" href="/gnuboard5/css/animate.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="/gnuboard5/css/slick.css">', 0);
add_stylesheet('<link rel="stylesheet" href="/gnuboard5/css/comm.css">', 0);
if(G5_IS_MOBILE) {
