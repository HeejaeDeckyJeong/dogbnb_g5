...
<div id="hd">
    ...
    <div id="hd_wrapper" class="header_g">
<div id="hd_wrapper_bg"></div>
       <div id=hd_wrapper_inner>
            <div id="logo">
                <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
            </div>
            <div id="logo_w">
                <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo_w.png" alt="<?php echo $config['cf_title']; ?>"></a>
            </div>
            <nav id="gnb">
            <h2>메인메뉴</h2>
            <div class="gnb_wrap">
